 ...
 */
public class SimulationPartieClassique {
	public static void main(String[] args) {
		...
		Joueur joueur1 = new Joueur("Joueur1", parametrePartie.getNBPION(), parametrePartie.getCHIFUMI());
		Joueur joueur2 = new Joueur("Joueur2", parametrePartie.getNBPION(), parametrePartie.getCHIFUMI());
		...
		joueur1.poserPion(case00, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
		System.out.println("\n==== 'Le joueur1 pose un premier Pion' ====\n");
		System.out.println(joueur1);
		System.out.println(joueur1.getPion(Nature.CLASSIQUE));
		
		joueur2.poserPion(case01, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
		System.out.println("\n==== 'Le joueur2 pose un premier Pion' ====\n");
		System.out.println(joueur2);
		System.out.println(joueur2.getPion(Nature.CLASSIQUE));
		
		joueur1.poserPion(case02, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
		System.out.println("\n==== 'Le joueur1 pose un deuxième Pion' ====\n");
		System.out.println(joueur1);
		System.out.println(joueur1.getPion(Nature.CLASSIQUE));
		
		joueur2.poserPion(case03, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
		System.out.println("\n==== 'Le joueur2 pose un deuxième Pion' ====\n");
		System.out.println(joueur2);
		System.out.println(joueur2.getPion(Nature.CLASSIQUE));
		
		
		System.out.println("\n==== '"+ joueur2.getPseudo() +" pose ses Pions' ====\n");
		...
		System.out.println("\n==== '"+ joueur1.getPseudo() + " pose un Pion' ====\n");
		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
		...
		System.out.println("\n==== '" + joueur1.getPseudo() + " re-déplace le Pion vers l'ancienne case' ====\n");
...
//		System.out.println("\n==== '" + joueur1.getPseudo() + " tante de déplacer son Pion vers une case occupée' ====\n");
//		joueur2.deplacerPion(case11.getPion(), "bas", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		//System.out.println(case11);
...
//		joueur2.deplacerPion(case01.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		//System.out.println(case01);
//		//System.out.println(case00+"\n");
//		
//		joueur2.deplacerPion(case00.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		//System.out.println(case00);
//		//System.out.println(case05+"\n");
//		
//		joueur2.deplacerPion(case05.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		System.out.println(case05);
//		System.out.println(case04+"\n");
//
//		joueur2.deplacerPion(case04.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		//System.out.println(case04);
//		//System.out.println(case03+"\n");
//
//		joueur2.deplacerPion(case03.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		//System.out.println(case03);
//		//System.out.println(case02+"\n");
//
//		joueur2.deplacerPion(case02.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		//System.out.println(case02);
//		//System.out.println(case01+"\n");
//		
...
//		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case12, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
//		/*Sur un déplacement intra-couche*/
//		System.out.println("\n==== '" + joueur1.getPseudo() + " pose trois Pions et les déplace pour créer un alignement' ====\n");
//		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case13, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.deplacerPion(case13.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
//		/*Sur une pose de Pion inter-couche*/
//		System.out.println("\n==== '" + joueur1.getPseudo() + " pose trois Pions pour créer un alignement' ====\n");
//		joueur1.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case21, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
//		/*Sur un déplacement inter-couche*/
//		System.out.println("\n==== '" + joueur1.getPseudo() + " pose trois Pions les déplace pour créer un alignement' ====\n");
//		joueur1.poserPion(case00, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case01, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.deplacerPion(case10.getPion(), "droite", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
...
//		joueur1.poserPion(case20, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case00, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
...
//		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur2.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case12, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
//		/*Sur un déplacement intra-couche*/
...
//		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur2.poserPion(case13, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur2.deplacerPion(case13.getPion(), "gauche", plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
//		/*Sur une pose de Pion inter-couche*/
//		System.out.println("\n==== '" + joueur1.getPseudo() + " et "+ joueur2.getPseudo() + " posent des Pions pour créer un alignement non-valide' ====\n");
//		joueur2.poserPion(case10, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur1.poserPion(case11, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		joueur2.poserPion(case21, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
//		
//		/*Sur un déplacement inter-couche*/
//		System.out.println("\n==== '" + joueur1.getPseudo() + " et "+ joueur2.getPseudo() +" posent des Pions et les déplacent pour créer un alignement non-valide' ====\n");
//		joueur1.poserPion(case00, plateauPartie, skinPion, parametrePartie.getNBCOTE(), parametrePartie.getNBCOUCHE(), Nature.CLASSIQUE);
